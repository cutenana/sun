...
<div class="container">
	<div class="row">
	<?php $dosql->Execute("SELECT * FROM `#@__infolist` WHERE classid=16 AND delstate='' AND checkinfo=true ORDER BY orderid DESC LIMIT 3,1");
...
<!-- mainbody-->
<div class="subBody">
	<div class="subTitle"> <span class="catname">资讯中心</span> <span class="fr">您当前所在位置：首页>资讯中心</span>
		<div class="cl"></div>
	</div>
</div>
<!--mainbody-->
